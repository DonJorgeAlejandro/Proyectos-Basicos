# Juego TA-TE-TI Jorge Silva

# Definimos la estructura del tablero
...
# Definimos las posiciones en el tablero
...
while turno < 9:
    if jugador_1 == '':
        ...
        if turno_1:
            print(jugador_1 + ', Escoge una posición')
        else:
            print(jugador_2 + ', Escoge una posición')
